...
javac -Xlint:rawtypes,unchecked Test1.java; java Test1 | grep -v ok | grep -P "(^\s+[^\.]|failed)"
printf "$DIVIDER[Compiling + Running 'Test2']\n"
javac -Xlint:rawtypes,unchecked Test2.java; java Test2 | grep -v ok | grep -P "(^\s+[^\.]|failed)"
printf "$DIVIDER[Compiling + Running 'Test3']\n"
javac -Xlint:rawtypes,unchecked Test3.java; java Test3 | grep -v ok | grep -P "(^\s+[^\.]|failed)"
printf "$DIVIDER[Compiling + Running 'Test4']\n"
javac -Xlint:rawtypes,unchecked Test4.java; java Test4 | grep -v ok | grep -P "(^\s+[^\.]|failed)"
printf "$DIVIDER[Compiling + Running 'Test5']\n"
javac -Xlint:rawtypes,unchecked Test5.java; java Test5 | grep -v ok | grep -P "(^\s+[^\.]|failed)"
printf "$DIVIDER[Compiling + Running 'Test6']\n"
javac -Xlint:rawtypes,unchecked Test6.java; java Test6 | grep -v ok | grep -P "(^\s+[^\.]|failed)"
